...
public class SecondWindowController {
	...
	public SecondWindowController(Controller controller) {
	...
	public void initialize(double total, Controller controllerInstance) {
	    invoiceTotal = total;
	    invoiceTotalLabel.setText(String.format("%.2f EGP", invoiceTotal));
	    setupCashAmountListener();

	    // Assign the Controller instance received as an argument
    ...
    private double calculateInvoiceTotal() {
    	double total = 0.0;
        for (Item item : controller.getInvoiceItems()) {
